...
import com.shulv.study.jfinaldemo.config.Bootstrap;
...
public class JFinalDemoGenerator {
    ...
    public static DataSource getDataSource() {
        DruidPlugin druidPlugin = Bootstrap.createDruidPlugin();
        druidPlugin.start();
    ...
    public static void main(String[] args) {
        ...
        String modelPackageName = "com.shulv.study.jfinaldemo.model";
